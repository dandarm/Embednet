...
class GCN(torch.nn.Module):
    def __init__(self, neurons_per_layer, node_features=1, num_classes=2, autoencoder=False):
...
def GAEGCNEncoder(neurons_per_layer, node_features=1, num_classes=2, autoencoder=True):
    model = GAE(GCN(neurons_per_layer, node_features, num_classes, autoencoder))
    return model
